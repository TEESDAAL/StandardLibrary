...
public interface Maps$0 extends Sealed$0{
  default Object imm$$hash$1(Object p0){ // (oh)
    var k= toKey(p0);
    return new Map$3Instance(k,new LinkedHashMap<>());
  }
...
record Map$3Instance(OrderHashBy$1 keyOh, LinkedHashMap<MapKey,Object> elems) implements Map$3{
  ...
  @Override public Object read$keyOrderHash$0(){ return keyOh; }
  ...
  @Override public Object mut$with$2(Object p0,Object p1){
    ...
    return new Map$3Instance(keyOh,m);
  }
  ...
  @Override public Object read$cmp$4(Object p0,Object p1,Object p2,Object m){
    ...
    var a= (Map$3Instance)p1;
    var b= (Map$3Instance)p2;
  ...
  @Override public Object mut$flow$0(){
    return new BiFlow$2Instance(
            SizedLane.of(elems.keySet().stream().map(k -> k.key), elems.size()),
            SizedLane.of(elems.values().stream(), elems.size())
    );
  }
