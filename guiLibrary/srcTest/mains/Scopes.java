...
import base.*;
class Scopes{
  static final Scope$1 id=new Scope$1(){public Object mut$run$1(Object p0){ return p0;}};
  static Color$0 transparent(){ return (Color$0) Color$0.instance.imm$transparent$0(); }
  static Color$0 boringGray(){ return (Color$0) Color$0.instance.imm$boringGray$0(); }
  static Color$0 black(){ return (Color$0) Color$0.instance.imm$voidBlack$0(); }
  static Color$0 bananaBruise(){ return (Color$0) Color$0.instance.imm$bananaBruise$0(); }
  ...
  static int nat(Object n){ return (int)Util.natToInt(n); }
  static int byt(Object b){ return ((Byte$0Instance)b).val(); }
